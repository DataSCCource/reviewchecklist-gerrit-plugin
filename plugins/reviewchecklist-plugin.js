...
<dom-module>
    <template is="dom-if" if="[[checkpointsExists]]">
        ...
        <template is="dom-repeat" items="[[checklistPoints]]">
            <label>
            <input type="checkbox" name="checkboxgroup" checked="{{item.checked::change}}" onchange="evaluateCodeReviewLabel()">
...
var hookElement;
var replyApi;
function evaluateCodeReviewLabel() {
